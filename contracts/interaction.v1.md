...
6. **Explain usable capabilities.** Actions and catalogs distinguish available controls, mounted tools and authored definitions; configuration inspection uses loaded metadata, names omissions, never calls a model or exposes credential values. Unsupported intentions have reasons, never simulated success.
