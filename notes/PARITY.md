...
| Return | Same-identity canonical CLI/TUI project sessions in ordinary Resume/search/recall; names, session settings and context writeback; legacy isolated TUI return preserved | Shared writer leases, private-control/cost interchange, shared uncertainty recovery and arbitrary module-private state; switch clients sequentially |
