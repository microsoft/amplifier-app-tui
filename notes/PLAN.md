...
| MEDIA-04 | interaction.v1:3, continuity.v1:2 | Attachment sets, clipboard images, references and queued media | Frozen bytes/identities survive rejection, queue and reopen; no hidden reads or submissions | Four-image sets, thumbnails, Linux desktop clipboard and queued images delivered in rc2. MEDIA-05 adds semantic file/line references to the same admission record; non-Linux clipboard and broader formats remain |
