...
| READ-08 | presentation.v1:3, presentation.v1:6, presentation.v1:7 | Structural Markdown layout | Nested and multiline lists retain hanging indentation and block spacing at 40/80/175 columns in streaming and final output | Implemented; styled streaming equivalence and native source-copy checks |
...
| SHARED-04 | presentation.v1:4, ecosystem.v1:2, ecosystem.v1:6 | Cross-client accounting and controls | Known CLI usage survives return without double-counting; pins/modes/goals/children retain supported ownership and state | Recorded accounting implemented with explicit gaps; private-control interchange remains pending |
| RETURN-01 | interaction.v1:1, continuity.v1:3 | CLI return-list accuracy | Transcript-line counts are labelled messages; log-only directories do not masquerade as resumable sessions | Implemented and pinned; CLI PR346 CI passes, normal reviewer approval still required |
