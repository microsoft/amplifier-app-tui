...
|---|---|---|---|---|
| LIVE-01 | continuity.v1:6, session.v1:6, interaction.v1:1 | Reciprocal Foundation handoff | Busy sessions remain readable; explicit Continue here and graceful outbound release preserve draft/history; timeout/failure/races never steal ownership | Implemented; Foundation PR399 and coordinated CLI PR356 dependency update are merged |
| LIVE-02 | continuity.v1:7, performance.v1:2, ecosystem.v1:5 | User-aware idle release and fresh reacquisition | Five minutes without runtime work or observed input; no release during decisions/auxiliary work/external editing; repaint/polling never renew; next mutation reloads external changes | Implemented; clock-boundary and native-input/editor gates pass; conservative remount, not warm worker reuse |
| RETURN-02 | continuity.v1:2, ecosystem.v1:2 | Pristine provider-control receipts | Changed composition may refresh an empty default receipt; explicit, unknown and uncertain selections remain preserved/refused | Implemented; five synthetic native-resume cases pass, exact reported user session not identified |
...
| SHARED-06 | ecosystem.v1:2, continuity.v1:2, session.v1:7 | Propose portable controls and recovery upstream | DRAFT Foundation proposal identifies data ownership, unsupported participants, no-replay boundaries and cross-client checks | Foundation PR397 merged as DRAFT documents; design review/adapter implementation remain, no ratification or conformance claim |
