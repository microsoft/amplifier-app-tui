...
|---|---|---|---|---|
| LIFE-07 | session.v1:8, ecosystem.v1:5 | Own cooperative cancellation before forced bridge cancellation | Deterministic cancellation phases, bounded grace, no late receipt writes; real-preset warnings reproduced and retested | Implemented; 468-case integrated run reports no warnings, both-preset live Stop/exit passes. Arbitrary bridge/module and detached cleanup remain open |
